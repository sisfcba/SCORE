...
int GeraDadosRel( t_args *Arg, t_cabec *Cab, t_dados *Dad, t_rodape *Rod )
{
  ...
  BufEv.Evento[1]  = FIM_DESVIO_TENSAO;
  BufEv.Evento[2]  = CFG_PAR_CUBA;
  BufEv.Evento[3]  = EVENTO_INC_OPERACAO;
  BufEv.Evento[4]  = EV_AGARRACAM;
  BufEv.Evento[5]  = EV_PROVQUEB;
  BufEv.NumEvs = 6;
  BufEv.DataAtual = HoraAtual; \
  BufEv.DataFinal = HoraFinal;
  BufEv.DataInicial = HoraInicial;
