...
#define _TRACE_PROC         (1 << 12)
  ...
  #define _TRACE_PROC_NEWPROG         (_TRACE_PROC | 32)
  #define _TRACE_PROC_EXECPROG        (_TRACE_PROC | 33)
  #define _TRACE_PROC_PSIGNAL         (_TRACE_PROC | 34)
...
#define _TRACE_SOCKET       (6 << 12)
  ...
  #define _TRACE_SOCKET_BADCKSUM      (_TRACE_SOCKET |  6)
  #define _TRACE_SOCKET_NEWCL         (_TRACE_SOCKET |  7)
  #define _TRACE_SOCKET_MESSAGE       (_TRACE_SOCKET |  8)
  #define _TRACE_SOCKET_PPPLONG       (_TRACE_SOCKET |  9)
  #define _TRACE_SOCKET_NEWMB         (_TRACE_SOCKET | 10)
  #define _TRACE_SOCKET_NOMX          (_TRACE_SOCKET | 11)
  #define _TRACE_SOCKET_MEM_SLEEP     (_TRACE_SOCKET | 12)
  #define _TRACE_SOCKET_MEM_WAKE      (_TRACE_SOCKET | 13)
  #define _TRACE_SOCKET_NOTHREAD      (_TRACE_SOCKET | 14)
  #define _TRACE_SOCKET_CHKSRC        (_TRACE_SOCKET | 15)
  #define _TRACE_SOCKET_CHKSRC_NOSRT  (_TRACE_SOCKET | 16)
  #define _TRACE_SOCKET_CHKSRC_SRTIF  (_TRACE_SOCKET | 17)
  #define _TRACE_SOCKET_MAXNX         (_TRACE_SOCKET | 99)
...
#define _TRACE_PHOTON           (8 << 12)
  ...
  #define _TRACE_PHOTON_PHFONT           (_TRACE_PHOTON | 108)
