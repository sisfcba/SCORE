...
typedef struct Pt_terminal_widget {
	...
	char				*font;				/* Pt_ARG_TERM_FONT */
	char				**fonts;			/* Pt_ARG_TERM_FONT_LIST */
	...
	/* Callback lists: */
	PtCallbackList_t	*resize;			/* Pt_CB_TERM_RESIZE	*/
	PtCallbackList_t	*resized;			/* Pt_CB_TERM_RESIZED	*/
	PtCallbackList_t	*fontch;			/* Pt_CB_TERM_FONT		*/
	PtCallbackList_t	*prvcmd;			/* Pt_CB_TERM_PRIVCMD	*/
	PtCallbackList_t	*key;				/* Pt_CB_TERM_INPUT		*/
	PtCallbackList_t	*optcb;				/* Pt_CB_TERM_INPUT		*/
	PtCallbackList_t	*appcb;				/* Pt_CB_TERM_APP		*/
	PtCallbackList_t	*hscb;				/* Pt_CB_TERM_SCRLBK	*/
...
extern char *PtTerminalFont( const char *fn, PhDim_t *size, PhPoint_t *offs );
struct termios;
