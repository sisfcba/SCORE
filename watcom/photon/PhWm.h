...
#define	Ph_WM_SET_ICON_SIZE			0x0020
	// icon_size overrides default WM icon size
	
#define	Ph_WM_SET_ICON_POS			0x0040
	// icon_pos overrides WM icon placement
...
#define	Ph_WM_TERMINATE				0x00000002
	...
	// managed_f		WM wont terminate until app responds to TERMINATE event
...
#define Ph_WM_ALL_FLAGS				0x00003F3D
