...
//	AVC.Abs[Cuba].BitCheckUp = 255;
   ...
   k=0;
	...
	CubaOpe = 1702;
	Cuba = ConvCubOperScore(CubaOpe);
	AVC.Param[Cuba].VSetPointCnf = 4.20;
	...
	CubaOpe = 1810;
	Cuba = ConvCubOperScore(CubaOpe);
	AVC.Param[Cuba].VSetPointCnf = 4.37;
	...
	CubaOpe = 1909;
	Cuba = ConvCubOperScore(CubaOpe);
	AVC.Param[Cuba].VSetPointCnf = 4.17;
	...
	*/
	...
	for(CubaOpe = 901; CubaOpe <= 972 ; CubaOpe++)
	{
		Cuba = ConvCubOperScore(CubaOpe);
		AVC.ParUser1[Cuba].Livre2 = 0.0;
		printf("\nAVC.ParUser1[ved%d].Livre2: %f", Cuba, AVC.ParUser1.Livre2);
	}
	for(CubaOpe = 1001; CubaOpe <= 1072 ; CubaOpe++)
	{
		Cuba = ConvCubOperScore(CubaOpe);
		AVC.ParUser1[Cuba].Livre2 = 0.0;
		printf("\nAVC.ParUser1[%d].Livre2: %f", Cuba, AVC.ParUser1[Cuba].Livre2);
	}
	for(CubaOpe = 1101; CubaOpe <= 1172 ; CubaOpe++)
	{
		Cuba = ConvCubOperScore(CubaOpe);
		AVC.ParUser1[Cuba].Livre2 = 0.0;
		printf("\nAVC.ParUser1[%d].Livre2: %f", Cuba, AVC.ParUser1[Cuba].Livre2);
	}
	for(CubaOpe = 1201; CubaOpe <= 1272 ; CubaOpe++)
	{
		Cuba = ConvCubOperScore(CubaOpe);
		AVC.ParUser1[Cuba].Livre2 = 0.0;
		printf("\nAVC.ParUser1[%d].Livre2: %f", Cuba, AVC.ParUser1[Cuba].Livre2);
