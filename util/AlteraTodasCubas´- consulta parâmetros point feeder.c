...
//	AVC.Abs[Cuba].BitCheckUp = 255;
   ...
   {
     Cuba = ConvCubOperScore(CubaOpe);
	 printf("Cuba: %d   - NivelProvQueb: %2.2f\n",CubaOpe,AVC.ParUser1[Cuba].NivelProvQueb);	 
   }
   ...
   for(CubaOpe = 1501; CubaOpe <= 1541 ; CubaOpe++)
   {
	...
	printf("\nCuba %d configurado NumAnasAtn8 = 3;\n", CubaOpe);

	CubaOpe = 1214;
	Cuba = ConvCubOperScore(CubaOpe);
	AVC.Abs[Cuba].NumAnasAtn8 = 3;
	printf("Cuba %d configurado NumAnasAtn8 = 3;\n", CubaOpe);
	...
	{
		case 2:
			for(CubaOpe = 301; CubaOpe <= 380; CubaOpe++)
			{
				Cuba = ConvCubOperScore(CubaOpe);
				AVC.Param[Cuba].VSetPointCnf += 0.02;
			}
			for(CubaOpe = 401; CubaOpe <= 480; CubaOpe++)
			{
				Cuba = ConvCubOperScore(CubaOpe);
				AVC.Param[Cuba].VSetPointCnf += 0.02;
			}
	...
	CubaOpe = 939;
	Cuba = ConvCubOperScore(CubaOpe);
	printf("\nCuba %d - EaHoraInicio: %d\n", CubaOpe, AVC.Ea[Cuba].EaHoraInicio);
	...
	switch(Comum->IdentReducao)
	{
		case 2:
			for(CubaOpe = 301; CubaOpe <= 380; CubaOpe++)
			{
				...
				//AVC.ParUser1[Cuba].Livre2 = 0;
				//AVC.ParUser1[Cuba].BufferSizeRH = 10;
				//AVC.ParUser1[Cuba].NivelProvQueb = -0.06;
				AVC.ParUser1[Cuba].QuantAlumCarga[0] = 1;
				AVC.ParUser1[Cuba].QuantAlumCarga[1] = 1;
				AVC.ParUser1[Cuba].QuantAlumCarga[2] = 1;
				AVC.ParUser1[Cuba].QuantAlumCarga[3] = 1;
			...
			for(CubaOpe = 401; CubaOpe <= 480; CubaOpe++)
			{
				...
				//AVC.ParUser1[Cuba].BufferSizeRH = 10;
				//AVC.ParUser1[Cuba].NivelProvQueb = -0.06;
				AVC.ParUser1[Cuba].QuantAlumCarga[0] = 1;				AVC.ParUser1[Cuba].QuantAlumCarga[0] = 1;
				AVC.ParUser1[Cuba].QuantAlumCarga[1] = 1;
				AVC.ParUser1[Cuba].QuantAlumCarga[2] = 1;
				AVC.ParUser1[Cuba].QuantAlumCarga[3] = 1;
			}
